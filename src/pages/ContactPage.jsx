        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            >
              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-6 sm:p-8 shadow-xl relative overflow-hidden group">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <button className="mt-4 flex w-full justify-center items-center gap-2 rounded-lg bg-[#25D366] px-3 py-5 text-base font-bold leading-6 text-white shadow-lg hover:bg-[#128C7E] transition-all duration-200 uppercase tracking-widest transform hover:scale-[1.01]" type="submit">
            ...
            >
              <div className="grid grid-cols-1 gap-4">
                <a className="group flex items-center gap-4 rounded-xl border border-slate-100 bg-slate-50 p-5 hover:border-primary/50 hover:bg-white hover:shadow-md transition-all" href="tel:9959194226">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-slate-900 group-hover:text-primary">+91 9959194226</p>
                  </div>
                </a>
                <a className="group flex items-center gap-4 rounded-xl border border-slate-100 bg-slate-50 p-5 hover:border-primary/50 hover:bg-white hover:shadow-md transition-all" href="mailto:flowreachmarketingsolutions@gmail.com">
                  <div className="flex h-12 w-12 flex-none items-center justify-center rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors">
                    <span className="material-symbols-outlined text-primary">mail</span>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-slate-500">Email Us</p>
                    <p className="text-lg font-bold text-slate-900 group-hover:text-primary break-all">flowreachmarketingsolutions@gmail.com</p>
                  </div>
                </a>
              ...
              <div className="relative w-full h-64 sm:h-80 rounded-2xl overflow-hidden border border-slate-200 shadow-lg bg-slate-100">
                <iframe
